...
GGIR produces a large number of variables in the output. There is a dictionary of variables on the GGIR vignette page, and further details on these in the documentation. For convenience, there is also a section in the lab's GENEActiv manual describing the key sleep variables and where to find them. A couple of extra variables not listed there are:
