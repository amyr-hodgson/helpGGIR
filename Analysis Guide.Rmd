...
There are two part 4 files, *part4_nightsummary_sleep_cleaned.csv*, which gives  and *part4_summary_sleep_cleaned.csv*. 
...
GGIR produces a large number of variables in the output. There is a dictionary of variables on the GGIR vignette page, and further details on these in the documentation. Here is a list of some of the key variables you may be interested in:

Variable              |    Description
----------------------|--------------------------------------------------------------------------------------------------------------
M5... (part 2)        | Variables relating to the most active 5 hours (window can be adjusted with winhr)
                      |
L5... (part 2)        | Variables relating to the least active 5 hours (window can be adjusted with winhr)
                      |
Spt... (part 4)       | These variables relate to the 'sleep period time' window. See van Hees (2018) *Scientific Reports* for more details.
                      |
nightwak (part 5)     | Night waking
                      |
M10  (part 5)         | Variables relating to the most active 10 hours
                      |
L5   (part 5)         | Variables relating to the least active 5 hours
                      |
